...
abstract class AbstractRestRequest extends \Omnipay\Common\Message\AbstractRequest
{
    ...
    {
        return $this->formatCurrency($this->getParameter('taxAmount'));
    }
    ...
    {
        return $this->formatCurrency($this->getParameter('shippingAmount'));
    }
    ...
    {
        return $this->formatCurrency($this->getParameter('handlingAmount'));
    }
    ...
    {
        return $this->formatCurrency($this->getParameter('shippingDiscount'));
    }
    ...
    {
        return $this->formatCurrency($this->getParameter('insuranceAmount'));
    }
    ...
    {
        return $this->formatCurrency($this->getParameter('subtotalAmount'));
    }

    public function setSubtotalAmount($value)
    {
        return $this->setParameter('subtotalAmount', $value);
    }
