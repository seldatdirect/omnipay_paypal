...
class RestGateway extends AbstractGateway
{
     ...
     */
    public function fetchAuthorizeTransaction(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\PayPal\Message\RestFetchTransactionAuthorization', $parameters);
    }
